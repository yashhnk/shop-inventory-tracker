    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Track stock levels and inventory health (Live Data)
        </p>
      </div>
      ...
      <Card title="Current Inventory" subtitle="Live stock monitoring and spoilage tracking">
            ...
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">
                  Will this item expire before it gets sold?
                </th>
